...
import (
	...
	ludiumparams "github.com/Jeongseup/ludiumapp/app/params"
...
var (
	_ simapp.App              = (*LudiumApp)(nil)
	_ servertypes.Application = (*LudiumApp)(nil)
)

// SimApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
// NOTE: 우선 아티클에서는 LudiumApp으로 짓도록하고 과제에서 각자 원하시는 명칭으로 자신만의 앱체인을 만들 것입니다.
type LudiumApp struct {
	*baseapp.BaseApp
...
func init() {
	...
	// NOTE: 위에서 정의한 node-home
	DefaultNodeHome = filepath.Join(userHomeDir, nodeHomeDirName)
	// DefaultNodeHome = filepath.Join(userHomeDir, ".simapp")
}

// NewLudiumApp returns a reference to an initialized LudiumApp.
func NewLudiumApp(
	logger log.Logger,
	...
	// add capability keeper and ScopeToModule for some modules like ibc
	...
	app.mm = module.NewManager(
		...
		nameservicemodule.NewAppModule(appCodec, app.NameserviceKeeper, app.AccountKeeper, app.BankKeeper),
	)
...
/*
	NOTE: default method는 default_app_method.go로 이동
